...
(function () {
  ...
  describe('pkcs7', () => {
    ...
    it('should create PKCS#7 SignedData with content-type, message-digest, '
      + 'and signing-time attributes using GeneralizedTime (1949)', () => {
      // verify with:
      // openssl smime -verify -in p7.pem -signer certificate.pem \
      //   -out signedtext.txt -inform PEM -CAfile certificate.pem
      const p7 = PKCS7.createSignedData()
    ...
    it('should create PKCS#7 SignedData with content-type, message-digest, '
      + 'and signing-time attributes using UTCTime (1950)', () => {
      // verify with:
      // openssl smime -verify -in p7.pem -signer certificate.pem \
      //   -out signedtext.txt -inform PEM -CAfile certificate.pem
      const p7 = PKCS7.createSignedData()
    ...
    it('should create PKCS#7 SignedData with content-type, message-digest, '
      + 'and signing-time attributes using UTCTime (2049)', () => {
      // verify with:
      // openssl smime -verify -in p7.pem -signer certificate.pem \
      //   -out signedtext.txt -inform PEM -CAfile certificate.pem
      const p7 = PKCS7.createSignedData()
    ...
    it('should create PKCS#7 SignedData with content-type, message-digest, '
      + 'and signing-time attributes using GeneralizedTime (2050)', () => {
      // verify with:
      // openssl smime -verify -in p7.pem -signer certificate.pem \
      //   -out signedtext.txt -inform PEM -CAfile certificate.pem
      const p7 = PKCS7.createSignedData()
