...
const nav = [
  ...
  {
    text: 'Changelog',
    link: 'https://github.com/stacksjs/ts-security/blob/main/CHANGELOG.md',
  },
  {
    text: 'Resources',
    items: [
...
const title = `ts-security | ${description}`
...
export default withPwa(
  defineConfig({
    ...
    head: [
      ...
      ['meta', {
        name: 'tags',
        content: 'ts-security, stacksjs, certificate, ssl, SSL support, domain, multi-domain, zero-config',
      }],
      ...
      ['meta', { property: 'og:site_name', content: 'ts-security' }],
      ['meta', { property: 'og:image', content: './images/og-image.jpg' }],
      ['meta', { property: 'og:url', content: 'https://ts-security.sh/' }],
      ...analyticsHead,
    ],
